...
const sidebarItems = [
  ...
  { icon: FileText, label: "My Tickets", href: "/staff/tickets" },
  { icon: Award, label: "Licenses", href: "/staff/licenses" },
];
...
const notifications = [
  {
    id: 1,
    type: "new_assignment",
    message: "New ticket TKT-012 assigned to you",
    time: "5 min ago",
    read: false,
    ticketId: "TKT-012",
  },
  {
    id: 2,
    type: "user_reply",
    message: "User replied to ticket TKT-008",
    time: "20 min ago",
    read: false,
    ticketId: "TKT-008",
  },
  {
    ...
    message: "Documents uploaded for TKT-006",
    time: "1 hour ago",
    read: true,
    ticketId: "TKT-006",
  },
  {
    id: 4,
    type: "status_update",
    message: "Ticket TKT-004 status updated by Admin",
    time: "2 hours ago",
    read: true,
    ticketId: "TKT-004",
  },
                ...
                <DropdownMenuContent align="end" className="w-[280px] sm:w-80">
                  ...
                  <ScrollArea className="h-[300px] sm:h-80">
                    {notifications.map((notification) => (
                      <Link
                        key={notification.id}
                        to={`/staff/tickets/${notification.ticketId}`}
                ...
                <DropdownMenuTrigger asChild>
                  <button className="flex items-center gap-2 p-1 sm:p-1.5 rounded-xl hover:bg-accent transition-colors">
                    ...
                    <div className="hidden sm:block text-left">
                      <p className="text-sm font-medium text-foreground">Mike Staff</p>
