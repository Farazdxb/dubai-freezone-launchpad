    ...
    <section className="section-padding" style={{ background: "hsl(var(--neutral-700))" }}>
      <div className="container-wide">
        <div className="text-center max-w-2xl mx-auto mb-14">
          <p className="text-xs uppercase tracking-[0.2em] text-white/60 font-semibold mb-4">Perks & integrations</p>
          <h2 className="serif-display text-4xl sm:text-5xl lg:text-6xl text-white">
            Built for the UAE <em className="italic text-primary-glow">business ecosystem</em>
          </h2>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5">
          {perks.map((p, i) => (
            <motion.div
              ...
              className="rounded-3xl p-7 border border-white/10 hover:border-primary/60 transition-all duration-500"
